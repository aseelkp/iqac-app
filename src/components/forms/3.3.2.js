...
const validationSchema = Yup.object({
  ...
  ISSNno: Yup.number("ISSN Should be a number")
    .min(9999999, "ISSN no. should be 8 digits")
    .max(99999999, "ISSN no. should be 8 digits")
    .required("ISSN no. is required"),
...
function Form({ formData, setFormData }) {
  ...
  return (
    <div>
      <p className="mb-3">
        <span className="font-bold">3.3.2</span> Number of research papers per
        teachers in the Journals notified on UGC website during the year.
      </p>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={formik.handleChange}
                error={
                  formik.touched.nameOfAuthor &&
                  Boolean(formik.errors.nameOfAuthor)
                }
                helperText={
                  formik.touched.nameOfAuthor && formik.errors.nameOfAuthor
                }
              />
            </Grid>
            <Grid item xs={12} md={6}>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={formik.handleChange}
                error={
                  formik.touched.nameOfJournal &&
                  Boolean(formik.errors.nameOfJournal)
                }
                helperText={
                  formik.touched.nameOfJournal && formik.errors.nameOfJournal
                }
              />
            </Grid>
            <Grid item xs={12} md={6}>
        ...
        <div className="w-full mt-4 p-6">
          <table className="w-full">
            <thead className="text-left">
              <tr>
                <th className="p-2 border-2 border-blue-700">
                  Title of the paper
                </th>
                <th className="p-2 border-2 border-blue-700">
