...
function Form({ formData, setFormData }) {
  ...
  //   useEffect(() => {
  //     formData.form_5_2_1 && setTableData(formData.form_5_2_1);
  //   }, []);

  //   useEffect(() => {
  //     setFormData({ ...formData, form_5_2_1: tableData });
  //   }, [tableData]);

  return (
    <div>
      <p className="mb-3">
        <span className="font-bold">5.2.1</span> Number of placement of outgoing students during the year.
      </p>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={4}>
                <TextField
                    ...
                    id="nameOfStudent"
                    name="nameOfStudent"
                    label="Name of student placed with contact details"
                    variant="outlined"
            ...
            <Grid item xs={12} md={6}>
                <TextField
                    ...
                    id="nameOfEmployer"
                    name="nameOfEmployer"
                    label="Name of employer with contact details"
                    variant="outlined"
                    value={formik.values.nameOfEmployer}
                    onChange={formik.handleChange}
                    error={formik.touched.nameOfEmployer && Boolean(formik.errors.nameOfEmployer)}
                    helperText={formik.touched.nameOfEmployer && formik.errors.nameOfEmployer}
                />
            </Grid>
            <Grid item xs={12} md={6}>
                <TextField
                    ...
                    id="package"
                    name="package"
                    label="Pay package at appointment"
                    variant="outlined"
          ...
          <table className="w-full">
            <thead className="border-b-2 border-blue-700 text-left">
              <tr>
                ...
                <th className="p-2">Name of student with contact details</th>
                <th className="p-2">Program graduated from</th>
                <th className="p-2">Name of employer with contact details</th>
                <th className="p-2">Pay package at appointment</th>
              </tr>
            </thead>
            <tbody>
              {tableData.map((data, index) => {
                return (
                  <tr key={index}>
                    ...
                    <td className="px-2">{data.nameOfEmployer}</td>
                    <td className="px-2">{data.package}</td>
